...
// main function: Starting point for all our flutter app
// App layout using scaffold class
scaffold() {//D2:Widget tree
  runApp(
    MaterialApp(
      home: Scaffold(
        //Body of scaffold
